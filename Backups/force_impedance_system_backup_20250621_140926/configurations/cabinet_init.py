...
# Register trajectory network environment for dual network approach
from .config.franka.trajectory_network_env_cfg import (
    TrajectoryNetworkCabinetEnvCfg,
    TrajectoryNetworkCabinetEnvCfg_PLAY,
)

gym.register(
    id="Isaac-Open-Drawer-Franka-Trajectory-Network-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.franka.trajectory_network_env_cfg:TrajectoryNetworkCabinetEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:TrajectoryNetworkPPORunnerCfg",
    },
)

gym.register(
    id="Isaac-Open-Drawer-Franka-Trajectory-Network-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.franka.trajectory_network_env_cfg:TrajectoryNetworkCabinetEnvCfg_PLAY",
    },
)
...
# Register sequential dual network environment (trajectory first, then impedance)
from .config.franka.sequential_dual_network_env_cfg import (
    SequentialDualNetworkCabinetEnvCfg,
    SequentialDualNetworkCabinetEnvCfg_PLAY,
)

gym.register(
    id="Isaac-Open-Drawer-Franka-Sequential-Dual-Network-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.franka.sequential_dual_network_env_cfg:SequentialDualNetworkCabinetEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.sequential_dual_network_ppo_cfg:SequentialDualNetworkPPORunnerCfg",
    },
)

gym.register(
    id="Isaac-Open-Drawer-Franka-Sequential-Dual-Network-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.config.franka.sequential_dual_network_env_cfg:SequentialDualNetworkCabinetEnvCfg_PLAY",
    },
)
