    ...
    def __post_init__(self):
        ...
        self.actions.arm_action = OperationalSpaceControllerActionCfg(
            ...
            controller_cfg=OperationalSpaceControllerCfg(
                ...
                motion_stiffness_task=[150.0, 150.0, 150.0, 15.0, 15.0, 15.0],  # Reduced from default
                motion_stiffness_limits_task=(50.0, 1500.0),  # Reduced upper limit from 2000
        ...
        setattr(self.rewards, 'manipulation_contact_penalty', manipulation_contact_penalty)
        ...
        self.rewards.approach_gripper_handle.weight = 20.0  # Further boosted from 15.0 → 20.0 (CRITICAL)
        self.rewards.grasp_handle.weight = 12.0          # Further boosted from 8.0 → 12.0 (CRITICAL) 
        self.rewards.open_drawer_bonus.weight = 25.0    # Further boosted from 20.0 → 25.0
        self.rewards.multi_stage_open_drawer.weight = 8.0  # Further boosted from 5.0 → 8.0
